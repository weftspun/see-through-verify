...
The critical-path PERT diagram for [RFD 6](0006-cli-parity.qmd). Colors are
chosen in OKHSL (perceptually uniform): every role shares the same lightness
(fill L=0.34, border L=0.60, text L=0.82) and differs only by hue — green=done,
red=critical path, amber=optional.
