...
#line 38 "shaders/conv2d.slang"
struct GlobalParams_0
{
    StructuredBuffer<float> X_in_0;
    StructuredBuffer<float> W_in_0;
    StructuredBuffer<float> B_in_0;
...
#line 21
void _conv2d_kern(void* _S1, void* entryPointParams_0, void* globalParams_1)
{
...
#line 23
    uint32_t ow_0 = _S4 % (slang_bit_cast<GlobalParams_0*>(globalParams_1))->W_0;
    uint32_t oh_0 = _S4 / (slang_bit_cast<GlobalParams_0*>(globalParams_1))->W_0;
    uint32_t n_0 = _S3.z;

#line 25
    bool _S5;
    if(oc_0 >= ((&kernelContext_0)->globalParams_0->OC_0))
    {
...
#line 26
        _S5 = oh_0 >= ((&kernelContext_0)->globalParams_0->H_0);
...
#line 27
    float _S6 = (&kernelContext_0)->globalParams_0->B_in_0.Load(oc_0);
...
#line 28
        if(c_0 < ((&kernelContext_0)->globalParams_0->IC_0))
        {
        }
        else
        {
...
#line 29
            if(kh_0 < ((&kernelContext_0)->globalParams_0->KH_0))
            {
            }
            else
            {
...
#line 30
                if(kw_0 < ((&kernelContext_0)->globalParams_0->KW_0))
                {
                }
                else
                {
...
#line 31
                int32_t ih_0 = int32_t(oh_0 * (&kernelContext_0)->globalParams_0->STRIDE_0) - int32_t((&kernelContext_0)->globalParams_0->PAD_0) + int32_t(kh_0);
                int32_t iw_0 = int32_t(ow_0 * (&kernelContext_0)->globalParams_0->STRIDE_0) - int32_t((&kernelContext_0)->globalParams_0->PAD_0) + int32_t(kw_0);
                if(ih_0 < int(0))
                {
...
#line 33
                    _S5 = ih_0 >= int32_t((&kernelContext_0)->globalParams_0->H_0);
...
#line 33
                    _S8 = iw_0 >= int32_t((slang_bit_cast<GlobalParams_0*>(globalParams_1))->W_0);
...
#line 30
                s_1 = s_1 + (&kernelContext_0)->globalParams_0->W_in_0.Load(((oc_0 * (&kernelContext_0)->globalParams_0->IC_0 + c_0) * (&kernelContext_0)->globalParams_0->KH_0 + kh_0) * (&kernelContext_0)->globalParams_0->KW_0 + kw_0) * (&kernelContext_0)->globalParams_0->X_in_0.Load(n_0 * (&kernelContext_0)->globalParams_0->H_0 * (slang_bit_cast<GlobalParams_0*>(globalParams_1))->W_0 * (&kernelContext_0)->globalParams_0->IC_0 + c_0 * (&kernelContext_0)->globalParams_0->H_0 * (slang_bit_cast<GlobalParams_0*>(globalParams_1))->W_0 + uint32_t(ih_0) * (slang_bit_cast<GlobalParams_0*>(globalParams_1))->W_0 + uint32_t(iw_0));
...
#line 38
    *(&((&kernelContext_0)->globalParams_0->Y_out_0)[n_0 * (&kernelContext_0)->globalParams_0->OC_0 * (&kernelContext_0)->globalParams_0->H_0 * (slang_bit_cast<GlobalParams_0*>(globalParams_1))->W_0 + oc_0 * (&kernelContext_0)->globalParams_0->H_0 * (slang_bit_cast<GlobalParams_0*>(globalParams_1))->W_0 + oh_0 * (slang_bit_cast<GlobalParams_0*>(globalParams_1))->W_0 + ow_0]) = s_0;
    return;
}

// [numthreads(8, 8, 1)]
SLANG_PRELUDE_EXPORT
void conv2d_kern_Thread(ComputeThreadVaryingInput* varyingInput, void* entryPointParams, void* globalParams)
{
    _conv2d_kern(varyingInput, entryPointParams, globalParams);
}
// [numthreads(8, 8, 1)]
SLANG_PRELUDE_EXPORT
void conv2d_kern_Group(ComputeVaryingInput* varyingInput, void* entryPointParams, void* globalParams)
{
    ...
    for (uint32_t y = 0; y < 8; ++y)
    {
        ...
        for (uint32_t x = 0; x < 8; ++x)
        {
            ...
            _conv2d_kern(&threadInput, entryPointParams, globalParams);
        }
    }
}
// [numthreads(8, 8, 1)]
SLANG_PRELUDE_EXPORT
void conv2d_kern(ComputeVaryingInput* varyingInput, void* entryPointParams, void* globalParams)
{
    ...
    for (uint32_t z = vi.startGroupID.z; z < vi.endGroupID.z; ++z)
    {
        ...
        for (uint32_t y = vi.startGroupID.y; y < vi.endGroupID.y; ++y)
        {
            ...
            for (uint32_t x = vi.startGroupID.x; x < vi.endGroupID.x; ++x)
            {
                ...
                conv2d_kern_Group(&groupVaryingInput, entryPointParams, globalParams);
            }
        }
    }
}
