...
#line 45 "shaders/mha.slang"
struct GlobalParams_0
{
    StructuredBuffer<float> Q_in_0;
    StructuredBuffer<float> K_in_0;
    StructuredBuffer<float> V_in_0;
    RWStructuredBuffer<float> O_out_0;
    uint32_t TQ_0;
    uint32_t TK_0;
    uint32_t C_0;
    uint32_t H_0;
...
#line 15
void _mha_kern(void* _S1, void* entryPointParams_0, void* globalParams_1)
{
...
#line 15
    Vector<uint32_t, 3>  _S4 = _S3->groupID * Vector<uint32_t, 3> (8U, 8U, 1U) + _S3->groupThreadID;
    uint32_t i_0 = _S4.x;
    uint32_t c_0 = _S4.y;

#line 17
    bool _S5;
    if(i_0 >= ((slang_bit_cast<GlobalParams_0*>(globalParams_1))->TQ_0))
    {
...
#line 18
        _S5 = c_0 >= ((&kernelContext_0)->globalParams_0->C_0);
...
#line 19
    uint32_t _S6 = (&kernelContext_0)->globalParams_0->C_0 / (&kernelContext_0)->globalParams_0->H_0;

#line 19
    uint32_t _S7 = c_0 / _S6;
    uint32_t _S8 = (&kernelContext_0)->globalParams_0->C_0 / (&kernelContext_0)->globalParams_0->H_0;

#line 20
    float mx_0 = -1.00000001504746622e+30f;
...
#line 22
        if(j_0 < ((&kernelContext_0)->globalParams_0->TK_0))
        {
        }
        else
        {
...
#line 25
            uint32_t _S9 = _S7 * _S8 + d_0;

#line 25
            float s_1 = s_0 + (&kernelContext_0)->globalParams_0->Q_in_0.Load(i_0 * (&kernelContext_0)->globalParams_0->C_0 + _S9) * (&kernelContext_0)->globalParams_0->K_in_0.Load(j_0 * (&kernelContext_0)->globalParams_0->C_0 + _S9);
...
#line 24
        ...
        float s_2 = s_0 / (F32_sqrt((float(_S8))));
        if(s_2 > mx_0)
        {
...
#line 33
            uint32_t _S10 = _S7 * _S8 + d_0;

#line 33
            float s_3 = s_0 + (&kernelContext_0)->globalParams_0->Q_in_0.Load(i_0 * (&kernelContext_0)->globalParams_0->C_0 + _S10) * (&kernelContext_0)->globalParams_0->K_in_0.Load(j_0 * (&kernelContext_0)->globalParams_0->C_0 + _S10);
...
#line 32
        ...
        float denom_1 = denom_0 + (F32_exp((s_0 / (F32_sqrt((float(_S8)))) - mx_0)));
...
#line 41
            uint32_t _S11 = _S7 * _S8 + d_0;

#line 41
            float s_4 = s_0 + (&kernelContext_0)->globalParams_0->Q_in_0.Load(i_0 * (&kernelContext_0)->globalParams_0->C_0 + _S11) * (&kernelContext_0)->globalParams_0->K_in_0.Load(j_0 * (&kernelContext_0)->globalParams_0->C_0 + _S11);
...
#line 40
        ...
        float acc_1 = acc_0 + (F32_exp((s_0 / (F32_sqrt((float(_S8)))) - mx_0))) / denom_0 * (&kernelContext_0)->globalParams_0->V_in_0.Load(j_0 * (&kernelContext_0)->globalParams_0->C_0 + c_0);
...
#line 45
    *(&((&kernelContext_0)->globalParams_0->O_out_0)[i_0 * (&kernelContext_0)->globalParams_0->C_0 + c_0]) = acc_0;
    return;
}

// [numthreads(8, 8, 1)]
SLANG_PRELUDE_EXPORT
void mha_kern_Thread(ComputeThreadVaryingInput* varyingInput, void* entryPointParams, void* globalParams)
{
    _mha_kern(varyingInput, entryPointParams, globalParams);
}
// [numthreads(8, 8, 1)]
SLANG_PRELUDE_EXPORT
void mha_kern_Group(ComputeVaryingInput* varyingInput, void* entryPointParams, void* globalParams)
{
    ...
    for (uint32_t y = 0; y < 8; ++y)
    {
        ...
        for (uint32_t x = 0; x < 8; ++x)
        {
            ...
            _mha_kern(&threadInput, entryPointParams, globalParams);
        }
    }
}
// [numthreads(8, 8, 1)]
SLANG_PRELUDE_EXPORT
void mha_kern(ComputeVaryingInput* varyingInput, void* entryPointParams, void* globalParams)
{
    ...
    for (uint32_t z = vi.startGroupID.z; z < vi.endGroupID.z; ++z)
    {
        ...
        for (uint32_t y = vi.startGroupID.y; y < vi.endGroupID.y; ++y)
        {
            ...
            for (uint32_t x = vi.startGroupID.x; x < vi.endGroupID.x; ++x)
            {
                ...
                mha_kern_Group(&groupVaryingInput, entryPointParams, globalParams);
            }
        }
    }
}
